...
var MD5 = (function () {
    ...
    MD5.any_hmac_md5 = function (key, data, encoding) {
    ...
    MD5.rstr2any = function (input, encoding) {
        ...
        var dividend = new Array(input.length / 2);
     ...
     */
    MD5.HEX_FORMAT_LOWERCASE = 0;
    MD5.HEX_FORMAT_UPPERCASE = 1;
    MD5.BASE64_PAD_CHARACTER_DEFAULT_COMPLIANCE = "";
    MD5.BASE64_PAD_CHARACTER_RFC_COMPLIANCE = "=";
